import { LLRP_TD_RSVD_VERSION_TYPENUM, LLRP_TD_MESSAGE_LENGTH, LLRP_TD_MESSAGE_ID, LLRP_TD_PARAM_LENGTH, LLRP_TD_RSVD_TYPENUM, LLRP_TD_TV_TYPENUM } from "../const-td";
